...
(function() {
  jQuery(document).ready(function() {
    var currentGame, isStoryMode, load, processData, puzzleGame, retrieveResources;
    ...
    puzzleGame = (function() {
      ...
      puzzleGame.prototype.init = function(resources, amount) {
        var resourceLimit;
        this.resources = resources;
        this.resources.sort(function() {
          return 0.5 - Math.random();
        });
        resourceLimit = this.resources.slice(0, amount);
    ...
    retrieveResources(1000).then(function(res) {
      load();
      return currentGame.init(processData(res), 20);
    });
    $(this).hide();
    $('.winScreen').hide();
